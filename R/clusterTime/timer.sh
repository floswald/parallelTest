...
#$ -pe mpich 41  #  <- load the openmpi parallel env w/ $(arg1) slots
...
mpirun -np 41 /data/uctpfos/R/x86_64-unknown-linux-gnu-library/2.15/snow/RMPISNOW -q < timer.r > timer.Rout
